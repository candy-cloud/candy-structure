package com.candy.structure.metadata.controller;
...
//    }
    ...
    @RequestMapping(value = "/getTablesStr/{catalog}", method = RequestMethod.GET)
    public String getTablesStr(@PathVariable String catalog, String schemaPattern, String[] type, HttpServletRequest request, HttpServletResponse response) {
        Result result = structureService.getTables(catalog, schemaPattern, null, type);
