package com.candy.structure.metadata.service.impl;

import com.candy.structure.metadata.domain.db.StructureColumns;
import com.candy.structure.metadata.domain.db.StructureTable;
import com.candy.structure.metadata.domain.db.enums.StructureColumnsEnum;
import com.candy.structure.metadata.domain.db.enums.StructureTableEnum;
import com.candy.structure.metadata.service.StructureService;
...
public class StructureServiceImpl implements StructureService {
    ...
    public Result getTables(String catalog, String schemaPattern, String tableNamePattern, String types[]) {
        ...
        try {
            DatabaseMetaDataUsingInfoSchema metaData = (DatabaseMetaDataUsingInfoSchema)dataSource.getConnection().getMetaData();
